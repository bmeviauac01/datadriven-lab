...
A tárgykövetelményeket lásd a [hivatalos tantárgyi adatlapon](https://portal.vik.bme.hu/kepzes/targyak/VIAUAC16/).
...
A félév végi jegy a laborokra kapott (1-5 skálájú) osztályzatok matematikailag kerekített számtani átlaga. Határidőig nem leadott megoldás elégtelennel számítódik az átlagba.
...
**Ha otthonról készítem el a megoldást, hogyan kapok segítséget?** Amikor otthonról dolgozol, egy laborvezetőhöz tartozol. Ő felel a félév közben a feladatok beadása és ellenőrzése rendben történjen.
...
**Szóval Google és StackOverflow a megoldás?** Nem. Minden tudás, amire szükséged van, már előfordult egyetemi tanulmányaid során. A Google és a StackOverflow jó.... De! A választ is meg kell érteni. Lehet, hogy a megtalált válasz megoldás, csak épp nem a te problémádra.
